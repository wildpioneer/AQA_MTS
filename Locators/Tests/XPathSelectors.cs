...
public class XPathSelectors : BaseTest
{
    ...
    public void BasicXPathSelectors()
    {
        ...
        Assert.That(Driver.FindElement(By.XPath("//*[@class = 'top-logo']")).Displayed);
        ...
        Assert.That(Driver.FindElement(By.XPath("//*[starts-with(@title, 'Hello b')]")).Displayed);

        // Поиск элемента у которого значение аттрибута содержит подстроку
        Assert.That(Driver.FindElement(By.XPath("//*[contains(@title, 'ello b') and @style]")).Displayed);
        ...
        Assert.That(Driver.FindElement(By.XPath("//*[contains(text(), 'All Proje')]")).Displayed);
    ...
    public void AxesXPathTest()
    {
        ...
        Assert.That(Driver.FindElement(By.XPath("//h1/ancestor::div[@id = 'test']")).Displayed);
        ...
        Assert.That(Driver.FindElement(By.XPath("//div//a")).Displayed);
